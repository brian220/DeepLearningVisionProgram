...
def train_GAN(current_epoch_num):
    ...
    for epoch in range(num_epochs):
        ...
        torch.save(netG.state_dict(), '%s/netG_epoch_%d.pth' % (save_weight_dir, epoch + current_epoch_num))
        torch.save(netD.state_dict(), '%s/netD_epoch_%d.pth' % (save_weight_dir, epoch + current_epoch_num))
...
def genImage():
    ...
    #testG = torch.load('D:/user/Desktop/DLHW2/model/netG.pkl')
    testG.load_state_dict(torch.load('D:/user/Desktop/DLHW2/modelWeights/model2_3_weight/netG_epoch_24.pth'))
    for i in range(500):
        ...
        output_fig(img_array, file_name='D:/user/Desktop/DLHW2/outputs/{}_image'.format(str.zfill(str(i + 1), 3)))

if __name__ == '__main__':
    train_GAN_on_prev_dict()
